    ...
    const slides = [
        {
            ...
            description:
                "A place where every child's potential is discovered and nurtured through innovative education.",
        },
        {
            id: 2,
            ...
            description:
                "Equipped with the latest technology and resources to provide the best learning experience.",
        },
        {
            id: 3,
            ...
            description:
                "From early childhood to high school, we provide a comprehensive curriculum that prepares students for success.",
        },
        {
            id: 4,
            ...
            description:
                "Our comprehensive sports programs promote physical fitness, teamwork, and competitive spirit.",
        },
        {
            id: 5,
            ...
            description:
                "Fostering creativity and cultural appreciation through our comprehensive arts programs.",
        },
    ];
    ...
    return (
        <div className="relative h-screen overflow-hidden">
            ...
            <div className="absolute inset-0 flex items-center justify-center z-20">
                <div
                    className={`text-center text-white max-w-4xl mx-auto px-4 sm:px-6 transition-all duration-500 ease-in-out ${
                        isTransitioning
                ...
                >
                    ...
                    <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold mb-3 sm:mb-6">
                        {slides[currentSlide].subtitle}
                    </h2>
                    <p className="text-sm sm:text-base md:text-lg lg:text-xl mb-4 sm:mb-8 px-2 sm:px-0">
                        {slides[currentSlide].description}
                    </p>
                    <button className="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 sm:py-3 sm:px-8 rounded-lg text-sm sm:text-lg transition-all duration-300 hover:scale-105">
                        Explore Further
                        <svg
            ...
            {/* Thumbnail Carousel at Bottom - Hidden on mobile */}
            ...
            <div className="absolute inset-x-0 top-1/2 transform -translate-y-1/2 flex justify-between px-4 md:hidden z-30">
                <button
                    onClick={() =>
                        handleSlideChange(
